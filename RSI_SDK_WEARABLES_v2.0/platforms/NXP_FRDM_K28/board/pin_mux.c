...
//! Adding 2 GPIO pins for Power save
	...
	*/
    ...
    PORT_SetPinInterruptConfig(BOARD_INITPINS_PS_IN_PORT, BOARD_INITPINS_PS_IN_PIN, kPORT_InterruptLogicOne);

    /* Initialize GPIO functionality on pin PTA12 (pin J2715)  */
    GPIO_PinInit(BOARD_INITPINS_PS_IN_GPIO, BOARD_INITPINS_PS_IN_PIN , &PS_in_config);

    /* PORTA12 (pin J2715) is configured as PTA12 */
    PORT_SetPinMux(BOARD_INITPINS_PS_IN_PORT, BOARD_INITPINS_PS_IN_PIN, kPORT_MuxAsGpio);
