...
/*==============================================*/
/**
 * @fn         int32_t rsi_sha_pen(uint8_t sha_mode, uint8_t *msg, uint16_t msg_length, uint16_t chunk_len,
 * 										     uint8_t pending_flag, uint8_t *digest) 
 * @brief      Compute the sha digest
...
/*==============================================*/
/**
 * @fn         int32_t  rsi_hmac_sha_pen(uint8_t hmac_sha_mode, uint8_t *data, uint16_t total_length, uint16_t chunk_len,
 * 										     uint32_t key_length, uint8_t pending_flag, uint8_t *digest) 
 * @brief      Hold computed digest from HMAC-SHA
...
/*==============================================*/
/**
 * @fn         int32_t rsi_hmac_sha(uint8_t hmac_sha_mode, uint8_t *msg, uint32_t msg_length, uint8_t *key,
 *                                   uint32_t key_length, uint8_t *digest, uint8_t *hmac_buffer)                    
 * @brief      Decides whether the hmac-sha message can be sent once or requires multiple calls to send the message
 * @param[in]  hmac_sha_mode - 1 – For HMAC-SHA1 2 – For HMAC-SHA256 3 – For HMAC-SHA384 4 – For HMAC-SHA512 
 * @param[in]  msg           - Pointer to message 
 * @param[in]  msg_length    - Total message length
...
/*==============================================*/
/**
 * @fn         int32_t rsi_aes(uint16_t aes_mode, uint16_t enc_dec, uint8_t *msg, uint16_t msg_length, uint8_t *key, 
 * 										 uint16_t key_length, uint8_t *iv, uint8_t *output)
 * @brief      Decides whether the aes message can be sent once or requires multiple calls to send the message
...
/*==============================================*/
/**
 * @fn         int32_t rsi_aes_pen(uint8_t aes_mode, uint8_t enc_dec, uint8_t *msg, uint16_t msg_length, uint16_t chunk_length, uint8_t *key, uint16_t key_length,
...
/*==============================================*/
/**
 * @fn         int32_t rsi_exponentiation(uint8_t *prime, uint32_t prime_length, uint8_t *base, uint32_t base_length, 
 * 																uint8_t *exponent, uint32_t exponent_length, uint8_t *exp_result)
 * @brief      Calculates the DH key
...
/*==============================================*/
/**
 * @fn         int32_t rsi_ecdh_point_multiplication(uint8_t ecdh_mode, uint8_t *d, uint8_t *sx, uint8_t *sy, uint8_t *sz, 
...
/*==============================================*/
/**
 * @fn         int32_t rsi_ecdh_point_addition(uint8_t ecdh_mode, uint8_t *sx, uint8_t *sy, uint8_t *sz, 
...
/*==============================================*/
/**
 * @fn         int32_t rsi_ecdh_point_subtraction(uint8_t ecdh_mode, uint8_t *sx, uint8_t *sy, uint8_t *sz, 
 * 																		 uint8_t *tx, uint8_t *ty, uint8_t *tz, uint8_t *rx, uint8_t *ry, uint8_t *rz)
