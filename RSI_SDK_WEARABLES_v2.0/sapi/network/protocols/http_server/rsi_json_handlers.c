...
/*==============================================*/
/**
 * @fn          void rsi_json_object_scan_list_update(rsi_json_object_t* json_object, rsi_rsp_scan_t *scan_rsp)
 ...
 * @brief       Helper function which actually performs the json object update received from the browser.
 * @param[in]   json_object - json object data
 ...
 * @brief       Extract the file name from the json object string
 * @param[in]   json   - json object data string
 ...
 * @brief       Check given input is integer value or not
 ...
 * @brief       Check given input is float value or not
 * @param[in]   c - input value
 * @return      0 - Success \n
 *              1 - Failure
 *
