 ...
 * @brief      Exit/restore critical section.
 ...
 * @brief        Create the semaphore instance 
 * @param[in]    semaphore - Semaphore handle pointer  
 * @param[in]    count - Resource count
 * @param[out]   semaphore - Semaphore handler created   
 * @return       0              - Success \n 
 *               Negative Value - Failure 
 *
 */
 ...
 * @brief       Wireless library Wireless Library to the semaphore to initial state
 * @param[in]   semphore - Semaphore handle pointer  
 * @return      0              - Success \n 
 *              Negative Value - Failure
 *
