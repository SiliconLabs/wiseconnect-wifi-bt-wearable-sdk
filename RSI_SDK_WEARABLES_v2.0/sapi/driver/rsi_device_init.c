 ...
 * @param[out]  src_addr   - pointer contain the buffer of content to be written
 * @param[in]   size_param - Size of param
 ...
 *              set RSI_FW_START_OF_FILE in flags.For the last chunk set RSI_FW_END_OF_FILE in flags. 
 ...
 * @brief       enabling integrity check bypass
 * @param[in]   void
 * @return      0              - Success \n
 *              Non-Zero Value - Failure
 */
 ...
 * @brief       Get ram dump through master reads to work. 
