 ...
 * @brief       Send the C1 & C2 commands bytes, should check response for C1 command. Incase of busy should retry.
 ...
 * @pre         rsi_send_c1c2 should Success ful before this function.
 ...
 * @param[in]   uint8_t * int_status - pointer to the buffer of data to be read, assumed to be at least a byte 
 * @return      0 - SUCCESS \n
 *              -1 - SPI busy / Timeout \n
 *              -2 - SPI Failure  
 */
...
/*==================================================*/
/**
 * @fn          int16_t rsi_spi_pkt_len(uint16_t *length) 
