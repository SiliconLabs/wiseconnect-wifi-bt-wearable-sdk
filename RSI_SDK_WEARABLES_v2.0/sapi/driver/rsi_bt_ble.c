...
*/
/**
 * @fn          void rsi_bt_clear_wait_bitmap(uint16_t protocol_type, uint8_t sem_type)
...
/**
 * @fn          void rsi_bt_set_wait_bitmap(uint16_t protocol_type, uint8_t sem_type)
...
*/
/**
 * @fn          void rsi_bt_common_register_callbacks(rsi_bt_get_ber_pkt_t rsi_bt_get_ber_pkt_from_app)
...
/**
 * @fn          uint16_t rsi_bt_get_proto_type(uint16_t rsp_type, rsi_bt_cb_t **bt_cb)
...
/**
 * @fn         uint32_t rsi_bt_get_timeout(uint16_t cmd_type, uint16_t protocol_type) 
...
#ifdef RSI_BLE_ENABLE
/**
 * @fn          void rsi_ble_update_le_dev_buf(rsi_ble_event_le_dev_buf_ind_t *rsi_ble_event_le_dev_buf_ind)
...
/**
 * @fn          void rsi_add_remote_ble_dev_info(rsi_ble_event_enhance_conn_status_t *remote_dev_info)
...
/**
 * @fn          void rsi_remove_remote_ble_dev_info(rsi_ble_event_disconnect_t *remote_dev_info)
...
/**
 * @fn          int32_t rsi_driver_process_bt_resp(rsi_bt_cb_t *bt_cb, rsi_pkt_t *pkt,
                void (*rsi_bt_async_callback_handler)(rsi_bt_cb_t *cb, uint16_t type, uint8_t *data, uint16_t length),
                uint16_t protocol_type)  
...
/**
 * @fn          uint16_t rsi_driver_process_bt_resp_handler(rsi_pkt_t *pkt)
 * @brief       Process BT RX packets
 * @param[in]   pkt      - pointer to received RX packet 
 * @return      0              - Success \n 
 *              Non-Zero Value - Failure
...
/**
 * @fn         int8_t rsi_bt_cb_init(rsi_bt_cb_t *bt_cb, uint16_t protocol_type)
...
/**
 * @fn         uint16_t rsi_bt_global_cb_init(rsi_driver_cb_t *driver_cb, uint8_t *buffer)
...
*/
/**
 * @fn         void rsi_bt_common_init(void)
...
#ifdef RSI_BT_ENABLE
/**
 * @fn          void rsi_bt_gap_register_callbacks(rsi_bt_on_role_change_t bt_on_role_change_status_event,
...
*/
/**
 * @fn          void rsi_bt_gatt_extended_register_callbacks(rsi_bt_on_gatt_connection_t bt_on_gatt_connection_event,
...
*/
/**
 * @fn          void rsi_bt_avdtp_events_register_callbacks(rsi_bt_on_avdtp_stats_t bt_on_avdtp_stats_event) 
...
/**
 * @fn          void rsi_bt_pkt_change_events_register_callbacks(rsi_bt_pkt_change_stats_t bt_pkt_change_stats_event)
...
*/
/**
 * @fn          void rsi_bt_on_chip_memory_status_callbacks_register(
...
/**
 * @fn          void rsi_bt_ar_events_register_callbacks(rsi_bt_on_ar_stats_t bt_on_ar_stats_event) 
...
/**
 * @fn          void rsi_bt_l2cap_register_callbacks(rsi_bt_on_l2cap_connect_t bt_on_l2cap_connect_event,
...
/**
 * @fn          void rsi_bt_hid_register_callbacks(rsi_bt_on_hid_connect_t bt_on_hid_connect_event,
 *                                  rsi_bt_on_hid_rx_data_t bt_on_hid_rx_data_event,
 *                                  rsi_bt_on_hid_handshake_t bt_on_hid_handshake_event,
 *                                  rsi_bt_on_hid_control_t bt_on_hid_control_event,
 *                                  rsi_bt_on_hid_get_report_t bt_on_hid_get_report,
...
/**
 * @fn          void rsi_bt_spp_register_callbacks(rsi_bt_on_spp_connect_t bt_on_spp_connect_event,
...
/**
 * @fn          void rsi_bt_a2dp_register_callbacks(rsi_bt_on_a2dp_connect_t bt_on_a2dp_connect_event,
...
/**
 * @fn          void rsi_bt_avrcp_register_callbacks(rsi_bt_on_avrcp_connect_t bt_on_avrcp_connect_event,
...
/**
 * @fn          void rsi_bt_avrcp_target_register_callbacks(
...
/**
 * @fn          void rsi_bt_hfp_register_callbacks(rsi_bt_on_hfp_connect_t bt_on_hfp_connect_event,
...
/**
 * @fn          void rsi_bt_pbap_register_callbacks(rsi_bt_on_pbap_connect_t bt_on_pbap_connect_event,
...
/**
 * @fn          void rsi_bt_iap_register_callbacks(rsi_bt_app_iap_conn_t bt_app_iap_conn,
 ...
 * @param[in]	  bt_app_on_iap2_data_rx - iap2 data recive 
 * @param[in]	  bt_app_iap2_File_Transfer_state - iap2 file transfer state 
 * @param[in]	  bt_app_iap2_File_Transfer_data - ia file transfer data
 * @return      void
 */
...
*/
/**
 * @fn          void rsi_bt_callbacks_handler(rsi_bt_cb_t *bt_classic_cb, uint16_t rsp_type, uint8_t *payload, uint16_t payload_length) 
  ...
  switch (rsp_type) {
    ...
    case RSI_BT_EVT_DISCONNECTED: // TODO: how is it diff from unbond?
    {
      if (bt_specific_cb->bt_on_disconnect_event != NULL) {
        /* GAR-7701: Removing resetting powersave state, as
           * after BT disconnection, we are not able to put Module
           * into Active state */
...
/*==============================================*/
/**
 * @fn         void rsi_ble_gap_register_callbacks(rsi_ble_on_adv_report_event_t ble_on_adv_report_event,
...
/*==============================================*/
/**
 * @fn         void rsi_ble_gap_extended_register_callbacks(rsi_ble_on_remote_features_t ble_on_remote_features_event,
...
*/
/**
 * @fn          void rsi_ble_smp_register_callbacks(rsi_ble_on_smp_request_t ble_on_smp_request_event,
...
/**
 * @fn          void rsi_ble_gatt_register_callbacks(rsi_ble_on_profiles_list_resp_t ble_on_profiles_list_resp,
...
/*==============================================*/
/**
 * @fn         void rsi_ble_gatt_extended_register_callbacks(rsi_ble_on_mtu_exchange_info_t ble_on_mtu_exchange_info_event)
 * @brief      Register GATT Extended responses/events callbacks.
 * @pre        \ref rsi_wireless_init() API needs to be called before this API.
 * @param[in]  ble_on_mtu_exchange_info_event  - Call back function for MTU Exchange information Event
 * @note        For more information about each callback, please refer to GATT Extended callbacks description section.
 * @return      void
 */
...
*/
/**
 * @fn         void rsi_ble_callbacks_handler(rsi_bt_cb_t *ble_cb, uint16_t rsp_type, uint8_t *payload, uint16_t payload_length)
 * @brief      Initailize the BT callbacks register. 
...
/**
 * @fn          void rsi_ble_on_chip_memory_status_callbacks_register(chip_ble_buffers_stats_handler_t ble_on_chip_memory_status_event)
...
int32_t rsi_bt_driver_send_cmd(uint16_t cmd, void *cmd_struct, void *resp)
{
  ...
  if (bt_cb->buf_status || bt_cb->cmd_status) {
    ...
    if (bt_cb->buf_status == 2) {
      status = RSI_ERROR_BLE_DEV_BUF_IS_IN_PROGRESS;
    } else if (bt_cb->buf_status == RSI_TRUE) {
...
//Start BT-BLE Stack
/**
 * @fn          int32_t intialize_bt_stack(uint8_t mode)
