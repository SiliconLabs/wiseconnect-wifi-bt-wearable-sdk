 ...
 * @brief       Wireless library to check and update the cmd state to progress state.
 * @param[in]   cmd_type - Command type
 * @param[in]   timeout_ms - Time out 
 * @return      0              - Success \n 
 *              Non-Zero Value - Failure
 */
...
/*==============================================*/
/**
 * @fn          int32_t rsi_post_waiting_common_semaphore(void)
 ...
 * @brief       rsi_post_waiting_bt_semaphore
 * @param[in]   void  
 * @return      void
 *
 *
...
/*==============================================*/
/**
 * @fn          void rsi_error_timeout_and_clear_events(uint32_t error)
