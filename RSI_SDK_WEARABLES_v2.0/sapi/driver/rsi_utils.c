 ...
 * @param[in]	asciiMacFormatAddress - Source address to convert, must be a null terminated string. This is input parameter.  
 * @param[out]	hex_addr              - Converted hex address is returned here. This is output parameter.  
 * @return		Hex address 
 */
 ...
 * @param[in]    asciiMacFormatAddress - Converted ASCII mac address is returned here. This is output parameter.  
 * @param[out]	 hex_addr              - Hex address input. This is input parameter. 
 * @return		 0              - Success \n 
 *               Non-Zero Value - Failure 
 */
 ...
 * @brief       Convert given ASCII hex notation to decimal notation (used for mac address). 
 * @param[in]   cBuf - ASCII hex notation string. This is input parameter. 
 ...
 * @param[in]     hexAddr               - Converted hex address is returned here. This is output parameter.  
 * @return        void 
 */
 ...
 * @param[in]  ip - IP address to convert. This is input parameter 
