...
void rsi_ble_main_app_task()
{
  ...
  //! start BT inquiry after BLE and PROP_PROTOCOL initialization
#if RSI_ENABLE_BT_TEST
  //!	wait for PROP_PROTOCOL initialization
#if RSI_ENABLE_PROP_PROTOCOL_TEST
  rsi_semaphore_wait(&ble_scan_sem, 0);
#endif
  //! PROP_PROTOCOL and BLE initialization completed, so start BT inquiry
