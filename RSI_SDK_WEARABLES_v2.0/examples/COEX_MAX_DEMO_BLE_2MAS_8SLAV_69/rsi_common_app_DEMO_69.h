...
#ifndef SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_COMMON_APP_DEMO_69_H
#define SAPIS_EXAMPLES_RSI_DEMO_APPS_INC_RSI_COMMON_APP_DEMO_69_H
#include <rsi_common_app.h>
#if COEX_MAX_APP_BLE_2MAS_8SLAV
#include <stdio.h>
#include <rsi_os.h>
#include <rsi_ble_device_info_DEMO_69.h>
...
#define WLAN_SYNC_REQ \
  0 //! Enable this macro to start bt,ble and prop_protocol activites after wlan connection, else all activities starts concurrently
#endif
...
#ifndef RSI_HTTP_SOCKET_TASK_PRIORITY
...
#define RSI_BLE_APP_TASK_SIZE           (1024 * 8)
