 ...
 */ /* TO BE UPDATED IN THE LWIPOPTS.h */
...
#ifdef LWIP_CUSTOM_CONFIG
#ifndef MEM_SIZE
#define MEM_SIZE (nps_LWIP_MEM_SIZE_KB * 1024)
#endif
#else
...
#define ARP_TABLE_SIZE (nps_LWIP_ARP_TABLE_SIZE)
#endif
#else
 ...
 */
#ifndef IP_FRAG
#define IP_FRAG 1 // need to disable if any issue found
#endif
...
/**
 * LWIP_DHCP_BOOTP_FILE==0: Default to no BOOTP support
 */
 ...
 */
#ifndef LWIP_AUTOIP
#define LWIP_AUTOIP (nps_LWIP_AUTOIP_ENABLE)
#endif
...
#define LWIP_DHCP_AUTOIP_COOP ((LWIP_AUTOIP) && (LWIP_DHCP))
#endif
...
#define DNS_TABLE_SIZE (nps_LWIP_DNS_TABLE_SIZE)
#endif
#else
#define DNS_TABLE_SIZE 5
#endif
...
#define LWIP_NETBUF_RECVINFO (nps_LWIP_NETBUF_RECVINFO)
#endif
#else
#define LWIP_NETBUF_RECVINFO 0 //////if dhcp fails need to 1
#endif
/*
   ---------------------------------
   ---------- TCP options ----------
...
#define PBUF_POOL_BUFSIZE \
  LWIP_MEM_ALIGN_SIZE(TCP_MSS + 40 + PBUF_LINK_HLEN) //////if issue observed  need to change it to 1524
#endif
 ...
 * netifapi_ routines transfer operations to the stack thread and wait.
 */
...
/* enabled because of it will reference custom pbuf
...
#define TCPIP_THREAD_NAME "NPS TCPIP"
#endif
...
#define TCPIP_THREAD_PRIO (nps_CONFIG_THREAD_PRIORITY)
#endif
#else
...
#define SLIPIF_THREAD_NAME "NPS SLIPIF"
#endif
...
#define SLIPIF_THREAD_PRIO (nps_CONFIG_THREAD_PRIORITY)
#endif
...
#define PPP_THREAD_NAME "NPS PPP"
#endif
...
#define PPP_THREAD_PRIO (nps_CONFIG_THREAD_PRIORITY)
#endif
...
#define DEFAULT_THREAD_NAME "NPS"
#endif
...
#define DEFAULT_THREAD_PRIO (nps_CONFIG_THREAD_PRIORITY)
#endif
#endif
/**
...
/**
 * LWIP_STATS_LARGE==1: Use 32-bits for stats storage
 */
...
#ifdef LWIP_CUSTOM_CONFIG
#ifndef PPP_SUPPORT
#define PPP_SUPPORT NPS_PPP_SUPPORT
#endif
#else
...
// Using zero here actually means that 1 Terminate-Request is sent.  See fsm.c::terminate_layer()
#define FSM_DEFMAXTERMREQS 0 /* Maximum Terminate-Request transmissions */
#endif
...
/**
 * LWIP_DEBUG: Define LWIP_DEBUG to enable LwIP debugging
 *
 * #define LWIP_DEBUG
 */
